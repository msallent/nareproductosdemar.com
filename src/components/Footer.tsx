    ...
    <section id="footer" className="section">
      <div className="flex flex-1 flex-col justify-between">
        <div className="flex flex-1 flex-col items-center justify-center gap-5">
          <div className="text-center font-medium sm:font-normal">
            <p className="text-6 sm:text-14 md:text-20">Hola!</p>
            <p className="text-6 sm:text-10 md:text-13">
              Estaremos en contacto
            </p>
          </div>

          <form className="flex w-43 flex-col gap-3.5 sm:w-70">
            <input
              type="text"
              placeholder="Nombre"
              className="text-6 sm:text-10 md:text-13 rounded-md border border-black px-2 py-1.5 placeholder:uppercase"
            />
            ...
            <textarea
              ...
              className="text-6 sm:text-10 md:text-13 resize-none rounded-md border border-black px-2 py-1.5 placeholder:uppercase"
            />

            <p className="text-6 sm:text-11 md:text-15 mx-auto mt-5 w-25 rounded-full bg-[#CCCDCE] py-1.5 text-center sm:w-40 sm:py-2 md:py-3">
              Enviar
            </p>
          </form>
        </div>

        <footer className="flex items-center justify-center gap-4 bg-[#CCCDCE] py-9.5 sm:gap-6.5 sm:py-11 md:gap-12">
          <a href="https://instagram.com/nareproductosdemar" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="size-4.5 rounded-sm bg-black fill-[#CCCDCE] p-0.5 sm:size-7 sm:rounded-md md:size-12.5"
            >
