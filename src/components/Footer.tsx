  ...
  return (
    <section id="footer" className="section">
      <div className="flex flex-1 flex-col justify-between">
        <div className="flex flex-1 flex-col items-center justify-center gap-5 lg:gap-7">
          <div className="text-center font-medium sm:font-normal">
            <p className="text-6 sm:text-14 lg:text-20">Hola!</p>

            <p className="text-6 sm:text-10 lg:text-13">
        ...
        <footer className="flex items-center justify-center gap-4 bg-[#CCCDCE] py-9.5 sm:gap-6.5 sm:py-11 lg:gap-10">
          <a href="https://instagram.com/nareproductosdemar" target="_blank">
            <svg
              ...
              viewBox="0 0 24 24"
              className="size-4.5 rounded-sm bg-black fill-[#CCCDCE] p-0.5 sm:size-7 sm:rounded-md lg:size-10 lg:rounded-lg"
            >
