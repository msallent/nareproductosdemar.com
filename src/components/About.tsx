  ...
  return (
    <section id="about" className="section">
      <section className="relative flex-1 sm:basis-[55%]">
        <div className="text-8 sm:text-12 lg:text-14 absolute inset-x-1/2 top-[45%] w-49 -translate-1/2 text-center font-bold sm:w-72 lg:w-84">
          <p>
        ...
        <div className="text-6 sm:text-8 lg:text-10 absolute inset-x-[8.2%] bottom-[11.42%] flex justify-between sm:inset-x-1/2 sm:w-2/3 sm:-translate-x-1/2 lg:w-127">
          <p>Buenos Aires</p>
          <p>Argentina</p>
        </div>
      </section>
      ...
      <section className="flex flex-1 items-center justify-center bg-[#CCCDCE] sm:basis-[45%]">
        <div className="flex gap-10 sm:gap-30 lg:gap-60">
          <p className="text-10 sm:text-16 lg:text-20 w-20 font-bold sm:w-32 lg:w-40">
            Cuidados y procesos
          </p>

          <p className="text-7 sm:text-10 lg:text-11 w-46 sm:w-56 lg:w-61.5">
